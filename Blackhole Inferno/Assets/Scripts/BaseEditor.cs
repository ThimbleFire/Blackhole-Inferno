...
public enum STICKERTYPE {
    STATION, PLANET, JUMPGATE, BELT, ROCK    
}
...
public class BaseEditor : EditorWindow
{
    ...
    protected void PaintVector3Field(ref Vector3 value, string label = "")
    {
        value = EditorGUI.Vector3Field(new Rect(4, Y, position.width - Right, 20), label, value); AddRow();
    }
    ...
    protected void PaintEnum<T>(ref T index, string label = "")
    {
        index = (T)(object)EditorGUILayout.EnumPopup(label, (Enum)(object)index);
        AddRow();
    }
